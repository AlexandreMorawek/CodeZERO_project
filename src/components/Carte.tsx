	...
	return (
		...
		<div className="w-[80%] mx-auto pt-5">
			...
			<div className=" text-secondary py-4 text-center md:grid md:grid-cols-2">
				<p className="py-3 md:py-7 cursor-pointer">{answer1}</p>
				<p className="py-3 md:py-7 cursor-pointer">{answer2}</p>
				<p className="py-3 md:py-7 cursor-pointer">{answer3}</p>
				<p className="py-3 md:py-7 cursor-pointer">{answer4}</p>
			</div>
